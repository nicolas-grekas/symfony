...
abstract class BaseNode implements NodeInterface
{
     ...
     *
     * Nodes that declare they cannot hold a dynamic value use it to replace placeholders
    ...
    {
        if (null !== self::$placeholderResolver && $this->getAttribute('cannot_be_dynamic', false)) {
    ...
    {
        if (null !== $this->handlingPlaceholder && $this->getAttribute('cannot_be_dynamic', false)) {
            // the value is resolved before it is used, so there is no dynamic value to validate
            return;
        }
