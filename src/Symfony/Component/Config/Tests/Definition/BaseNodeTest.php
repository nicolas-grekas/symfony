...
class BaseNodeTest extends TestCase
{
    ...
    public function testNodesThatCannotBeDynamicAreResolved()
    {
        $tree = (new TreeBuilder('root'))
            ->getRootNode()
                ->children()
                    ->scalarNode('static')->cannotBeDynamic()->end()
    ...
    public function testNodesThatCannotBeDynamicAcceptAResolvedArray()
    {
        $tree = (new TreeBuilder('root'))
            ->getRootNode()
                ->children()
                    ->arrayNode('locales')->cannotBeDynamic()->scalarPrototype()->end()->end()
                ->end()
            ->end()
            ->buildTree()
        ;
