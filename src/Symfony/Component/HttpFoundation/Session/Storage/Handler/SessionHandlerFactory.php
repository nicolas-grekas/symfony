...
{
    public static function createHandler(\Redis|\RedisArray|\RedisCluster|\Predis\ClientInterface|RedisProxy|RedisClusterProxy|\Memcached|\PDO|string $connection): AbstractSessionHandler
    {
