...
class ConfigDumpReferenceCommandTest extends AbstractWebTestCase
{
    ...
    {
        $name = ['foo', 'default_config_test', 'extension_without_config_test', 'services', 'console', 'mime', 'json_path', 'process', 'framework', 'test', 'test_dump', 'DefaultConfigTestBundle', 'ExtensionWithoutConfigTestBundle', 'MimeBundle', 'ServicesBundle', 'JsonPathBundle', 'ConsoleBundle', 'ProcessBundle', 'FrameworkBundle', 'ServicesInBuildTestBundle', 'TestBundle'];
