...
class JsonSchemaConfigDumpPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        $generator = new JsonSchemaDumper(parameterSchemas: [['$ref' => '#/$defs/types/param']], resolveExtension: static fn (string $alias): ?string => isset($trees[$alias]) ? '#/$defs/nodes/'.$alias : null);
